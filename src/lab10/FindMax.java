...
public class FindMax {
	...
	public static void main(String[] args) {
	    ...
	    new FindMax().printMaxByThread();
		
	}
	
	public void printMaxByThread(){
		int[] max1=new int[3];
		...
		executor.execute(new Runnable(){
			@Override
			public void run(){
				max1[1]=findMax(30,59);
			}
		});
		executor.execute(new Runnable(){
			@Override
			public void run(){
				max1[2]=findMax(60,89);
			}
		});
		System.out.println("By multi-thread: "+Math.max(max1[2],Math.max(max1[0],max1[1])));
